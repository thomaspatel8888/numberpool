...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-numberCampaigns">
                <thead>
                    <tr>
                        <th width="10">
                ...
                <tbody>
                    @foreach($campaigns as $key => $campaign)
                        <tr data-entry-id="{{ $campaign->id }}">
                            ...
                            <td>
                                @foreach($campaign->numbers as $key => $item)
...
@endcan
  ...
  let table = $('.datatable-numberCampaigns:not(.ajaxTable)').DataTable({ buttons: dtButtons })
