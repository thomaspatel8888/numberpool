...
@can('campaign_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            ...
            @include('csvImport.modal', ['model' => 'Campaign', 'route' => 'admin.campaigns.parseCsvImport'])
        </div>
    </div>
@endcan
<div class="card">
            ...
            <thead>
                ...
                <tr>
                    ...
                    <td>
                        <select class="search" strict="true">
                            <option value>{{ trans('global.all') }}</option>
                            @foreach(App\Models\Campaign::DEDUP_LIMIT_SELECT as $key => $item)
                                <option value="{{ $key }}">{{ $item }}</option>
                            @endforeach
                        </select>
                    </td>
...
{ data: 'dedup', name: 'dedup' },
{ data: 'dedup_limit', name: 'dedup_limit' },
{ data: 'number', name: 'numbers.number' },
